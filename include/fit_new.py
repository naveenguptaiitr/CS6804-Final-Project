...
def fit(net,
    ...
    if net_input is not None:
        ...
        width = int(img_clean_var.data.shape[2]/16) #value changed from 32 to 16
        height = int(img_clean_var.data.shape[3]/16) #value changed from 32 to 16
        ...
        def closure():
            ...
            if num_iter == 1000:
                if i % 100 == 0:
                    ...
                    epoch_loss_list.append((loss.data)*1000)
    ...
    return mse_wrt_noisy, mse_wrt_truth, net_input_saved, epoch_loss_list
